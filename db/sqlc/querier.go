...
type Querier interface {
	...
	GetProviderOverallRating(ctx context.Context, providerID int64) (GetProviderOverallRatingRow, error)
	GetReviewByID(ctx context.Context, id int64) (Review, error)
	GetServiceByID(ctx context.Context, id int64) (Service, error)
	GetServiceByProviderID(ctx context.Context, providerID int64) (Service, error)
	...
	ListReviewsByProviderID(ctx context.Context, arg ListReviewsByProviderIDParams) ([]Review, error)
	...
	ListServicesByProviderID(ctx context.Context, arg ListServicesByProviderIDParams) ([]Service, error)
	ListServicesByTitle(ctx context.Context, arg ListServicesByTitleParams) ([]Service, error)
